...
# GitHub workflow script for archiving Rust workspace binaries
# This script collects all compiled binaries from a Rust cargo workspace
# and creates a single tar.bz2 archive
